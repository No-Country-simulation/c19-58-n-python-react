    ...
    <section className="Hero--container flex justify-center items-center p-20 ">
        ...
        <div className="Hero--info flex flex-col justify-center items-center p-20">
            ...
            <div className="Button--Hero--Container w-[60%] flex flex-col mt-4 gap-2">
                <button className="bg-red-400 cursor-pointer p-3 rounded-xl text-white font-semibold">Contactanos</button>
                <button className="bg-black cursor-pointer p-3 rounded-xl text-white font-semibold" >Como llegar?</button>
            </div>
        </div>
