...
export const Contact = () => {
  return (
    <>
        <section className="form bg-neutral-900 h-60 w-full flex justify-center items-center gap-5 ">
        ...
        <section className="bg-red-800 h-60 w-full text-white flex justify-center items-center gap-5">
