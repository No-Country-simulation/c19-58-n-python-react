...
export const Hero = () => {
  return (
    <>
    <section id="inicio" className=" Hero--container flex justify-center items-center p-20 ">
        ...
        <div className="Hero--info text-center flex flex-col justify-center items-center p-20">
            ...
            <img className="hero--img mt-4" src="/hero.png" alt="" />
            <p className="mt-2 ">  
            ...
            <div className="Button--Hero--Container sm:w-full lg:w-[60%] flex flex-col mt-4 gap-2">
                <button className="Hero-button bg-red-800  cursor-pointer  p-3 rounded-xl text-white font-semibold">Apoyar a la propuesta de ley</button>
                <button className="Hero-button bg-black cursor-pointer  p-3 rounded-xl text-white font-semibold" >Quiero una cita</button>
            </div>
        </div>
